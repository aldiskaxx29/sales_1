<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php if ($this->uri->segment('2') == 'LaporanSales'): ?> active <?php endif ?>">
                <a class="nav-link" href="<?= base_url('Pimpinan/LaporanSales/')  ?>"><i class="fas fa-users"></i> <span>Laporan Sales</span></a>
              </li>
