            ...
            <tbody>
              <?php foreach ($order as $no => $or): ?>
                <tr>
                  ...
                  <td>
                    <?php if ($or->status == 0): ?>
                      <small class="badge badge-warning" data-toggle="modal" data-target="#exampleModal<?= $or->id_order ?>" style="cursor: pointer;">Verifikasi</small>
...
<!-- Modal -->
<?php foreach ($order as $no => $or): ?>
<div class="modal fade" id="exampleModal<?= $or->id_order ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Pimpinan/Orderan/verify') ?>" method="POST">
          <div class="form-group">
            ...
            <input type="hidden" name="id" value="<?= $or->id_order ?>">
