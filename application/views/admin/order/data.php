                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php elseif($or->status == 1): ?>
                      <small class="badge badge-light" data-toggle="modal" data-target="#exampleModalStatus<?= $or->id ?>" style="cursor: pointer;">Sudah di verifikasi Pimpinan</small>
        ...
        <form action="<?= base_url('Admin/Order/verify') ?>" method="POST">
          <div class="form-group">
            ...
            <select class="form-control" name="status">
              <option value="1">Sudah di verifikasi Pimpinan</option>
